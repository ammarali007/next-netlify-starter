      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
          ...
          <div className="result">
            <p>Initial Salary in PKR: <span id="initialSalaryResult">{initialSalaryResult}</span></p>
            <p>Adjusted Salary in PKR: <span id="adjustedSalaryResult">{adjustedSalaryResult}</span></p>
            <p>Increase in Value in PKR: <span id="increaseInValueResult">{increaseInValueResult}</span></p>
          </div>
        </div>
      </div>
    </div>
